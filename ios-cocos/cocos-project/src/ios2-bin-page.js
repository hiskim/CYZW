...
(function (global) {
    ...
    parts.bin = {
        ...
        _showBins: function () {
            ...
            importButton.setPosition(size.width - 38 - importButton.width / 2, this._navTop(size) - 176);
            var newGroupButton = common.actionButton('+ 新建分组', 18, this._createGroup.bind(this), cc.color(22, 163, 154, 255), 142);
            newGroupButton.setPosition(38 + newGroupButton.width / 2, this._navTop(size) - 176);
